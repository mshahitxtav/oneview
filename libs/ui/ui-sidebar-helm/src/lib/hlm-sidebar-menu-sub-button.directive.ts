...
export class HlmSidebarMenuSubButtonDirective implements OnInit {
  ...
  ngOnInit() {
    if (this.element.nativeElement.tagName.toLowerCase() !== 'a') {
      console.warn(
        'hlmSidebarMenuSubButton directive should only be used on <a> elements',
      );
    }
  }
}
